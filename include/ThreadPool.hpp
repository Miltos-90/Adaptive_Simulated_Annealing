/*
*  Implementation of the ThreadPool class to allow for parallel multistarts of the ASA algorithm.
*  Used in the ASA::minimize() function for multithreaded multistarts.
*
